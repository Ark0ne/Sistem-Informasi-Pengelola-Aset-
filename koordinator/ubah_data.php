...
if(isset($id)){//mengecek apakah variabel $id ada nilainya 
    ...
    $query = mysqli_query($konek, "select * from koordinator where nip_koordinator = '$id'");
...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa fa-bars"></i> Data Koordinator</h3>
                <ol class="breadcrumb">
                        ...
                        <form class="form-horizontal" action="aksi_ubah.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="text" name="nama" autocomplete="off" value="<?php echo $row ['nama_koordinator']; ?>" required class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" name="instansi" autocomplete="off" value="<?php echo $row ['instansi_koordinator']; ?>" required class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="text" name="kontak" autocomplete="off" value="<?php echo $row ['kontak_koordinator']; ?>" required class="form-control">
                                </div>
                            </div>                                                
                            <div class="form-group">
